...
import com.battagliandrea.beerappandroid.ui.details.BeerDetailsViewModel
...
class ViewModelModule {
    ...
    fun provideBeerDetailsViewModel(viewModel: BeerDetailsViewModel): ViewModel = viewModel
}